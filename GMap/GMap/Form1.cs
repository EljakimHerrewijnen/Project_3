...
namespace GMap
{
...

    {
        ...
        private void DrawRect_Click(object sender, EventArgs e)
        {
            ...
            GMarkerGoogle marker = new GMarkerGoogle(new PointLatLng(51.931856139360136, 4.563467502593994),
        ...
        {
            GMapOverlay markersOverlay = new GMapOverlay("markers");
            GMarkerGoogle marker = new GMarkerGoogle(new PointLatLng(53.93789705, (4.48100567 + count)), GMarkerGoogleType.green);
            markersOverlay.Markers.Add(marker);
            gmap.Overlays.Add(markersOverlay);
            count += 1;
            gmap.Zoom += 1;
